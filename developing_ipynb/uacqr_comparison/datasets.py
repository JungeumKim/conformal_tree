...
def GetDataset(name, base_path='/home-nfs/raphaelr/cqr_comparison/datasets/'):
    ...
    if name=='imdb_wiki_18':
        X = np.load(base_path+'IMDB_WIKI_RESNET18_X.npy')
        y = np.load(base_path+'IMDB_WIKI_RESNET18_y_date.npy')
    ...
    if name=='cbc':
        X = np.load('/share/data/willett-group/climate/data/Complete-Blood-Cell-Count-Dataset-master/X.npy')
        y = np.load('/share/data/willett-group/climate/data/Complete-Blood-Cell-Count-Dataset-master/y.npy')

        X_hflip = np.load('/share/data/willett-group/climate/data/Complete-Blood-Cell-Count-Dataset-master/X_hflip.npy')
        y_hflip = np.load('/share/data/willett-group/climate/data/Complete-Blood-Cell-Count-Dataset-master/y_hflip.npy')

        X_vflip = np.load('/share/data/willett-group/climate/data/Complete-Blood-Cell-Count-Dataset-master/X_vflip.npy')
        y_vflip = np.load('/share/data/willett-group/climate/data/Complete-Blood-Cell-Count-Dataset-master/y_vflip.npy')

        X = np.concatenate((X, X_hflip, X_vflip), axis=0)
        y = np.concatenate((y, y_hflip, y_vflip), axis=0)

    if name=='forest':
        X = np.load('/share/data/willett-group/climate/data/Forest Segmented/X.npy')
        y = np.load('/share/data/willett-group/climate/data/Forest Segmented/y.npy')
